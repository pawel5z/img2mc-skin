...
def img2skin(skin: Image, img_front: Image, img_back: Image) -> Image:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "template", help="Skin texture into which given images will be pasted.")
    parser.add_argument(
    ...
    res: Image = img2skin(Image.open(args.template), Image.open(
        args.front), Image.open(args.back))
    if args.out is None:
        bin_res = io.BytesIO()
